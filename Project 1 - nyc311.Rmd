...
#budg = sapply(new_city.split, budget)/3
...
#summary(lm(scale_comp$`budget` ~ scale_comp$factor+scale_comp$`per complaint`+ scale_comp$`max salary` + scale_comp$`employee count`, data = scale_comp))
```
```{r}
